...
public class PlayerMovement : NetworkBehaviour
{
    ...
    [SerializeField] private PlayerCombat playerCombat; // ✅ ADD THIS
    ...
    public override void OnStartLocalPlayer()
    {
        ...
        if (controller == null)
            Debug.LogError("Thiếu CharacterController trên PlayerMovement!");
    ...
    public void UpdatePlayer(float deltaTime)
    {
        ...
        // ✅ CHECK IF ATTACKING - BLOCK MOVEMENT INPUT
        ...
        // ✅ ONLY GET INPUT IF NOT ATTACKING
        if (!isAttacking)
        {
        ...
        {
            inputVector = Vector2.zero; // Force stop movement during attack
        }
    ...
    {
        // ✅ ALSO CHECK ATTACKING STATE HERE
        bool isAttacking = playerCombat != null && playerCombat.IsAttacking();

        if (isFrozen || isAttacking)
        {
            // Still apply gravity, just no horizontal movement
    ...
    {
        // ✅ PREVENT SPRINTING WHILE ATTACKING
        bool isAttacking = playerCombat != null && playerCombat.IsAttacking();
        if (isAttacking) return;
