...
public class MyTree : MonoBehaviour, IDamageable, IMinenable,Iinteractable
{
    ...
    //[SerializeField] private Transform fxTreeDestroyed;  // Hiệu ứng khi cây bị phá huỷ (tạm ẩn)
